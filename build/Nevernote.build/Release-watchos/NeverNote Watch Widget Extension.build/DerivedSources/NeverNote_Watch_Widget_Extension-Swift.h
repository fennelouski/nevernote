...
#ifndef NEVERNOTE_WATCH_WIDGET_EXTENSION_SWIFT_H
#define NEVERNOTE_WATCH_WIDGET_EXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NeverNote_Watch_Widget_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
